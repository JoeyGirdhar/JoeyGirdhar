...
def draw_svg():
    try:
        ...
        print("Error: contributions.json missing!")
        return
  ...
  <style>
    ...
    @keyframes slideDiagonal { from { opacity: 0; } to { opacity: 1; } }
  </style>
...
"""
  ...
  <text x="842" y="152" class="legend-text">More</text>
    ...
    print("Successfully built crisp vector template: contrib-heatmap.svg")
