def generate_card():
    svg_content = """<svg xmlns="http://w3.org" viewBox="0 0 490 380" width="490" height="380">
  <rect width="100%" height="100%" fill="#0d1117" rx="6"/>
  <style>
    .text { font-family: ui-monospace, SFMono-Regular, SF Mono, Menlo, Consolas, monospace; font-size: 13px; font-weight: 600; opacity: 0; animation: fadeIn 0.4s ease forwards; }
